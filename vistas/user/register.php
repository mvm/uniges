<h1><?=$strings["register_title"]?></h1>
<form action="/?controller=user&action=register_end" method="POST">
	...
	<button type="submit" class="btn btn-primary"><?= $strings["register_submit"] ?></button>
</form>
